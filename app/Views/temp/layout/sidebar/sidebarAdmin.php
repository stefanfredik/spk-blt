<ul class="sidebar-nav pt-1" data-coreui="navigation" data-simplebar="">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/profile">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="nav-icon bi bi-person-circle" viewBox="0 0 16 16">
    ...
    <li class="nav-item"><a class="nav-link" href="/penduduk">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
    ...
    <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
        ...
        <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="/laporan"><span class="nav-icon"></span> <i class="bi bi-people-fill mx-2"></i>Penduduk</a></li>
        </ul>
    </li>
