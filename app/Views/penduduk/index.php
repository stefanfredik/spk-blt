...
<div class="row">
    <div class="col">
        ...
        <button data-url="<?= '/' . $url . '/importexcel'; ?>" class="rounded-pill m-2 btn btn-outline-primary" onclick="add(this)"><i class="bi bi-plus-circle mx-1"></i>Import File Excel</button>
