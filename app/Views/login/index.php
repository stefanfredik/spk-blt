              ...
              <div class="card-body text-center">
                <form action="" onsubmit="login(event)">
                  ...
                  <div class="input-group mb-3"><span class="input-group-text">
                    ...
                    <input required id="username" name="username" class="form-control p-2" type="text" placeholder="Masukan Username">
                  </div>
                  <div class="input-group mb-4"><span class="input-group-text">
                    ...
                    <input required id="password" name="password" class="form-control p-2" type="password" placeholder="Masukan Password">
                  </div>
                  <div class="row">
                    <div class="col-12">
